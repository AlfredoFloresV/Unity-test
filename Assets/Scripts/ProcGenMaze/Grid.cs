...
public class Grid 
{
    ...
    private void createGrid() 
    {
        ...
        for (int i = 0; i < gridMap.GetLength(0); i++) 
        {
            ...
            {
                //Vertical lines
                //Debug.DrawLine(new Vector3(i, 0, j) * cellSize, new Vector3(i, 0, j + 1) * cellSize, Color.white, 100f);
                //Horizontal lines
                //Debug.DrawLine(new Vector3(i, 0, j) * cellSize, new Vector3(i + 1, 0, j) * cellSize, Color.white, 100f);
